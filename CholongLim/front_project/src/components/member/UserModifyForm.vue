    ...
    <div>
        ...
        <v-container class="member-box">
                <v-container>
                    ...
                    <div>
                        <v-text-field  label="전화번호" v-model="userPhone" 
                            type="phone" class="field-edit"></v-text-field>
                        <v-btn outlined class="ma-2 edit2" type="submit">수정완료</v-btn> 
                    </div>
                    </div>

                    <v-container class="before">
                        <v-row class="justify-center">
                            <v-btn color="blue" outlined class="ma-2 white--text" route :to="{ name: 'UserReadPage' }">
                                이전으로</v-btn> 
                        </v-row>
                    </v-container>
