...
import com.example.Mini.repository.board.NoticeCommentRepository2;
...
@Service
public class NoticeCommentService2Impl2 implements NoticeCommentService2 {

    @Autowired
    private NoticeCommentRepository2 repository;
