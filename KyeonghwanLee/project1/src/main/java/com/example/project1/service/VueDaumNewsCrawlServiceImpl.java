...
import com.example.project1.repository.DaumNewsRepository;
...
@Lazy
@Slf4j
public class VueDaumNewsCrawlServiceImpl implements com.example.project1.service.VueDaumNewsCrawlService {
    ...
    public void daumNewsCrawling(Elements elements, String category) {
        ...
        ProjectDaumNews news = null;

        for (int i = 0; i < elements.size(); i++) {
            news = new ProjectDaumNews();
