package com.example.project1.controller.jpa;
...
import com.example.project1.controller.jpa.response.ResponseSession;
import com.example.project1.controller.session.UserInfo;
import com.example.project1.entity.jpa.PrMember;

import com.example.project1.service.jpa.JPAMemberService;
import com.example.project1.service.jpa.SignInService;
...
public class JPAMemberController {
    ...
    public ResponseEntity<Void> jpaJPQLTest(
        ...
        Optional<PrMember> maybeMember = service.findByAuth(new Long(3));
        PrMember member = maybeMember.get();
