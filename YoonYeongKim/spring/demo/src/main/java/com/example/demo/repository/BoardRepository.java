...
public class BoardRepository {
    ...
    public void create(Board board) throws Exception {
        ...
        String query = "insert into board (title, content, writer, regDate) values (?, ?, ?, ?)";

        jdbcTemplate.update(query, board.getTitle(), board.getContent(), board.getWriter(), board.getRegDate());
    }
