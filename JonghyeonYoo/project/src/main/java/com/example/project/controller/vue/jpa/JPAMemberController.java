package com.example.project.controller.vue.jpa;

import com.example.project.controller.vue.jpa.request.MemberRequest;
import com.example.project.controller.vue.session.UserInfo;
import com.example.project.entity.jpa.Member;
import com.example.project.service.jpa.JPAMemberService;
...
public class JPAMemberController {
    ...
    public ResponseEntity<Void> jpaRegister(
        ...
        log.info("jpaRegister(): " + memberRequest.getUserId() + ", " + memberRequest.getPassword() + ", " +
                memberRequest.getName() + ", " + memberRequest.getDateOfBirth() + ", " + memberRequest.getPhoneNumber() + ", " +
