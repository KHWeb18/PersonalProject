...
import com.example.project.repository.jpa.JPAMemberAuthRepository;
import com.example.project.repository.jpa.JPAMemberRepository;
...
public class JPAMemberServiceImpl implements JPAMemberService {
    ...
    public void register(MemberRequest memberRequest) throws Exception {
        ...
        Member memberEntity = new Member(memberRequest.getUserId(), memberRequest.getPassword(),
                memberRequest.getName(), memberRequest.getDateOfBirth(),
